...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(<?php echo base_url()?>template/images/bg/02.jpg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
   ...
   <div class="service-3">
    <div class="row">
       ...
       <div class="col-lg-6 col-md-6 xs-mt-30 xs-mb-30">
         <img class="img-fluid full-width" src="<?php echo base_url()?>template/images/about/01.jpg" alt=""> 
       </div>
    </div>
    <!-- ============================================ -->
    <div class="row">
     ...
     <div class="col-lg-6 col-md-6">
         <img class="img-fluid full-width" src="<?php echo base_url()?>template/images/about/02.jpg" alt=""> 
       </div>
        <div class="col-lg-6 col-md-6 xs-mt-30 xs-mb-30">
          <div class="service-blog left text-left"> 
             <h3 class="theme-color">Apps & Game Development</h3>
              <p>Auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit ad litora torquent per conubia nostra, per inceptos himenaeos Mauris in erat justo</p>
              <b>02</b>
              <ul class="list list-unstyled">
    ...
    <div class="row">
       <div class="col-lg-6 col-md-6 xs-mt-30 xs-mb-30">
          <div class="service-blog text-right"> 
             <h3 class="theme-color">Seo Analysis & Design</h3>
              <p>Auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit ad litora torquent per conubia nostra, per inceptos himenaeos Mauris in erat justo</p>
              <b>03</b>
              <ul class="list list-unstyled">
       ...
       <div class="col-lg-6 col-md-6">
         <img class="img-fluid full-width" src="<?php echo base_url()?>template/images/about/03.jpg" alt=""> 
       </div>
    </div>
    <!-- ============================================ -->
    <div class="row">
     <div class="col-lg-6 col-md-6  xs-mt-30 xs-mb-30">
       ...
       <div class="col-lg-6 col-md-6 xs-mt-30">
          <div class="service-blog mb-0 left text-left"> 
             <h3 class="theme-color">Market Research</h3>
              <p>Auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit ad litora torquent per conubia nostra, per inceptos himenaeos Mauris in erat justo</p>
              <b>04</b>
              <ul class="list list-unstyled">
...
<section class="page-section-ptb parallax" data-jarallax='{"speed": 0.6}' style="background: url(<?php echo base_url()?>template/images/bg/05.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-9">
        <div class="section-title dark-bg">
            <h6 class="text-white">Who we are and what we do</h6>
            <h2 class="title-effect text-white">Get to know us better.</h2>
