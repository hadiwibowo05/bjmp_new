...
**/
	...
	// ADD CLASS
	jQuery("head").append('<link href="template/backend/assets/plugins/styleswitcher/styleswitcher.css" rel="stylesheet" type="text/css" />');
	...
	**/
	jQuery("input.dark_switch").bind("click", function() {
		...
		if(color_skin == 'dark') {
			...
			jQuery("head").append('<link id="css_dark_skin" href="template/backend/assets/css/layout-dark.css" rel="stylesheet" type="text/css" title="dark" />');
	...
	**/
	jQuery("input.rtl_switch").bind("click", function() {
		...
		if(_direction == 'rtl') {
			...
			jQuery("head").append('<link id="rtl_ltr_b1" href="template/backend/assets/plugins/bootstrap/RTL/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" title="rtl" />');
			jQuery("head").append('<link id="rtl_ltr_b2" href="template/backend/assets/plugins/bootstrap/RTL/bootstrap-flipped.min.css" rel="stylesheet" type="text/css" title="rtl" />');
			jQuery("head").append('<link id="rtl_ltr" href="template/backend/assets/css/layout-RTL.css" rel="stylesheet" type="text/css" title="rtl" />');
	...
	function setActiveStyleSheet(title) {
		if(title != 'null' && title != null) {
			jQuery("#color_scheme").attr('href', 'template/backend/assets/css/color_scheme/' + title + '.css');
	...
	**/
	function resetSwitcher() {
		...
		jQuery('body').attr('data-background', '');
		jQuery('.backstretch').remove();
		jQuery("a.logo img").attr('src', 'template/backend/assets/images/logo.png');
